...
urlpatterns = [
    ...
    path('company/details/',views.add_company_details.as_view()),
    path('company/details/<int:id>/',views.company_details_Update.as_view()),
    path('company/details/list/',views.company_list.as_view()),
    ...
    path('suppliers/contact/list/',views.list_suppliers_details.as_view(),name='add_company_details'),
