...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='raw_component_fin_bill_inward_details',
            fields=[
        ...
        migrations.CreateModel(
            name='raw_component_fin_dc_inward_details',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tenant_id', models.PositiveIntegerField()),
                ...
                ('financial_year', models.DateField(auto_now=True)),
                ('bill_reff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='inward.raw_component_fin_bill_inward_details')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='raw_component_fin_material_dc_inward',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tenant_id', models.PositiveIntegerField()),
                ...
                ('financial_year', models.DateField(auto_now=True)),
                ('raw_component_fin_dc_inward_details', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='inward.raw_component_fin_dc_inward_details')),
            ],
        ),
        migrations.CreateModel(
            name='raw_component_fin_material_bill_inward',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tenant_id', models.PositiveIntegerField()),
                ('job_order_price', models.PositiveIntegerField()),
                ...
                ('financial_year', models.DateField(auto_now=True)),
                ('raw_component_fin_bill_inward_details', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='inward.raw_component_fin_bill_inward_details')),
            ],
        ),
    ]
