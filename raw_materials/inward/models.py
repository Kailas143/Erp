...
class raw_component_fin_bill_inward_details(models.Model):
    ...
    raw_component_company_details = models.PositiveIntegerField()
...
class raw_component_fin_dc_inward_details(models.Model):
    ...
    raw_component_company_details = models.PositiveIntegerField()
    bill_reff = models.ForeignKey(raw_component_fin_bill_inward_details, null=True, blank=True, on_delete=models.CASCADE)
...
class raw_component_fin_material_dc_inward(models.Model):
    ...
    objects = FinancialQuerySet.as_manager()
    def __str__(self):
        return str(self.raw_component_fin_dc_inward_details) + '  -  ' + str(self.qty) + '  -  ' + str(self.id)